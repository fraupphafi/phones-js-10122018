export class PhonesPageComponent {
    constructor ({element}) { // передаём объект (options)
        this.element = element;
        this._render();
    }

    _render(){ // _ соглашение на приватные методы и свойства
          ...
          <ul class="phones">
            <li class="thumbnail">
              <a href="#!/phones/motorola-xoom-with-wi-fi" class="thumb">
                <img alt="Motorola XOOM™ with Wi-Fi" src="assets/img/phones/motorola-xoom-with-wi-fi.0.jpg">
              </a>
            ...
            <li class="thumbnail">
              <a href="#!/phones/motorola-xoom" class="thumb">
                <img alt="MOTOROLA XOOM™" src="assets/img/phones/motorola-xoom.0.jpg">
              </a>
            ...
            <li class="thumbnail">
              <a href="#!/phones/motorola-atrix-4g" class="thumb">
                <img alt="MOTOROLA ATRIX™ 4G" src="assets/img/phones/motorola-atrix-4g.0.jpg">
              </a>
            ...
            <li class="thumbnail">
              <a href="#!/phones/dell-streak-7" class="thumb">
                <img alt="Dell Streak 7" src="assets/img/phones/dell-streak-7.0.jpg">
              </a>
            ...
            <li class="thumbnail">
              <a href="#!/phones/samsung-gem" class="thumb">
                <img alt="Samsung Gem™" src="assets/img/phones/samsung-gem.0.jpg">
              </a>
            ...
            <li class="thumbnail">
              <a href="#!/phones/dell-venue" class="thumb">
                <img alt="Dell Venue" src="assets/img/phones/dell-venue.0.jpg">
              </a>
            ...
            <li class="thumbnail">
              <a href="#!/phones/nexus-s" class="thumb">
                <img alt="Nexus S" src="assets/img/phones/nexus-s.0.jpg">
              </a>
            ...
            <li class="thumbnail">
              <a href="#!/phones/lg-axis" class="thumb">
                <img alt="LG Axis" src="assets/img/phones/lg-axis.0.jpg">
              </a>
            ...
            <li class="thumbnail">
              <a href="#!/phones/samsung-galaxy-tab" class="thumb">
                <img alt="Samsung Galaxy Tab™" src="assets/img/phones/samsung-galaxy-tab.0.jpg">
              </a>
            ...
            <li class="thumbnail">
              <a href="#!/phones/samsung-showcase-a-galaxy-s-phone" class="thumb">
                <img alt="Samsung Showcase™ a Galaxy S™ phone" src="assets/img/phones/samsung-showcase-a-galaxy-s-phone.0.jpg">
              </a>
            ...
            <li class="thumbnail">
              <a href="#!/phones/droid-2-global-by-motorola" class="thumb">
                <img alt="DROID™ 2 Global by Motorola" src="assets/img/phones/droid-2-global-by-motorola.0.jpg">
              </a>
            ...
            <li class="thumbnail">
              <a href="#!/phones/droid-pro-by-motorola" class="thumb">
                <img alt="DROID™ Pro by Motorola" src="assets/img/phones/droid-pro-by-motorola.0.jpg">
              </a>
            ...
            <li class="thumbnail">
              <a href="#!/phones/motorola-bravo-with-motoblur" class="thumb">
                <img alt="MOTOROLA BRAVO™ with MOTOBLUR™" src="assets/img/phones/motorola-bravo-with-motoblur.0.jpg">
              </a>
            ...
            <li class="thumbnail">
              <a href="#!/phones/motorola-defy-with-motoblur" class="thumb">
                <img alt="Motorola DEFY™ with MOTOBLUR™" src="assets/img/phones/motorola-defy-with-motoblur.0.jpg">
              </a>
            ...
            <li class="thumbnail">
              <a href="#!/phones/t-mobile-mytouch-4g" class="thumb">
                <img alt="T-Mobile myTouch 4G" src="assets/img/phones/t-mobile-mytouch-4g.0.jpg">
              </a>
            ...
            <li class="thumbnail">
              <a href="#!/phones/samsung-mesmerize-a-galaxy-s-phone" class="thumb">
                <img alt="Samsung Mesmerize™ a Galaxy S™ phone" src="assets/img/phones/samsung-mesmerize-a-galaxy-s-phone.0.jpg">
              </a>
            ...
            <li class="thumbnail">
              <a href="#!/phones/sanyo-zio" class="thumb">
                <img alt="SANYO ZIO" src="assets/img/phones/sanyo-zio.0.jpg">
              </a>
            ...
            <li class="thumbnail">
              <a href="#!/phones/samsung-transform" class="thumb">
                <img alt="Samsung Transform™" src="assets/img/phones/samsung-transform.0.jpg">
              </a>
            ...
            <li class="thumbnail">
              <a href="#!/phones/t-mobile-g2" class="thumb">
                <img alt="T-Mobile G2" src="assets/img/phones/t-mobile-g2.0.jpg">
              </a>
            ...
            <li class="thumbnail">
              <a href="#!/phones/motorola-charm-with-motoblur" class="thumb">
                <img alt="Motorola CHARM™ with MOTOBLUR™" src="assets/img/phones/motorola-charm-with-motoblur.0.jpg">
              </a>
